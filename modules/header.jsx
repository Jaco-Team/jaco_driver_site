...
function DrawerHeader() {
	...
	return (
		...
		>
			<Box className={roboto.variable} sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
				<Box
					sx={{
						px: 2.5,
						pt: 2.5,
									...
									<ListItem disablePadding key={item.href}>
											<ListItemButton
												...
												sx={{
													...
													boxShadow: isSelected ? '0 14px 30px rgba(66, 98, 125, 0.12)' : '0 10px 22px rgba(15, 23, 42, 0.04)',
													overflow: 'hidden',
													'&.Mui-selected': {
		...
		<Box>
			<AppBar>
				<Toolbar>
					...
					<Typography variant="h6" component="div" sx={{flexGrow: 1}} style={{fontSize: globalFontSize}}>{pageTitle}</Typography>
					{
