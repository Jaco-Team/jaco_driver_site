...
export default function MapPage() {
	...
	const [globalFontSize, theme, mapScale, night_map, is_scaleMap] = useHeaderStore(state => [state.globalFontSize, state.theme, state.mapScale, state.night_map, state.is_scaleMap]);
				...
				<div style={night_map ? {
					...
					<YMaps query={{lang: 'ru_RU', apikey: 'f600fbbd-6500-4bf7-a0ab-ec9336f6c7d8'}}>
						...
						>
							...
							{is_scaleMap && <ZoomControl options={{size: 'large', position: {top: 200, right: 20}}}/>}
