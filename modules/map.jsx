  ...
  if (theme !== 'classic') {
    ...
    return (
      <Placemark
        ...
        options={{
          preset:
            parseInt(item?.status_order) == 6 ? 'islands#blueDotIcon' : 'islands#circleDotIcon',
...
const MapPointDriver = memo(function MapPointDriver({
  theme,
  mapScale,
  location_driver,
  globalFontSize,
...
export default function MapPage() {
  ...
  const [globalFontSize, theme, mapScale, night_map, is_scaleMap] = useHeaderStore((state) => [
  ...
  const [
    ...
    state.setType,
    state.home,
    state.location_driver,
    state.type_location,
    state.set_type_location,
    state.location_driver_time_text,
    ...
    <Meta title="Карта заказов">
        ...
        >
          <YMaps query={{ lang: 'ru_RU', apikey: 'f600fbbd-6500-4bf7-a0ab-ec9336f6c7d8' }}>
            ...
            >
              ...
              {location_driver && type_location !== 'none' && (
                <MapPointDriver
                  theme={theme}
                  mapScale={mapScale}
      ...
      >
        <Button
          ...
          onClick={() => setType({ id: 1, text: 'Активные' })}
        >
          Активные
        </Button>
        <Button
          ...
          onClick={() => setType({ id: 2, text: 'Мои отмеченные' })}
        >
          Мои
        </Button>
        <Button
          ...
          onClick={() => setType({ id: 5, text: 'У других курьеров' })}
        >
          У других
        </Button>
      </div>
