...
export default function MapPage() {
  const [getOrders, type, update_interval, limit, limit_count, setType] = useOrdersStore((state) => [state.getOrders, state.type, state.update_interval, state.limit, state.limit_count, state.setType]);
